...
document.addEventListener("touchend", (e) => {
  // check if the element triggered the event has a classname
  if (!e.target.className.includes("tile")) {
    return;
  }
  ...
  // check if the horizontal swipe is greater magnitude than vertical swipe
